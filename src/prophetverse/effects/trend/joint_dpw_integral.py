...
__all__ = ["JointDPWIntegralTrend", "FullModelIntegralTrend"]


class JointDPWIntegralTrend(PiecewiseLinearTrend):
...
# Backward-compatible alias. Prefer JointDPWIntegralTrend going forward.
